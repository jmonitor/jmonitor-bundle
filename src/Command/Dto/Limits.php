...
class Limits
{
    ...
    private function setMemoryLimit(string|int|null $memoryLimit): void
    {
        ...
        throw new \InvalidArgumentException('Memory limit is not parsable: pass a valid integer (bytes) or a shorthand string like "64M" (requires PHP 8.2+ or symfony/polyfill-php82).');
    }
}
